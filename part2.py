import math, sympy, numba  # Imports math library (used for basic calculations) and the sympy library (used for many calculus
# functions).
...
answer = newton(f, f_prime, 10, 10)
fAnswer = pretty(f(answer))
...
print(answer)
print(" ")
print("\nAnd if we plug this value into the original function, we see that the local minimum is " + fAnswer)